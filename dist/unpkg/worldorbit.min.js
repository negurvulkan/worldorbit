...
`)}function tr(e){let t=["schema 2.0",""];e.system&&t.push(...nn(e.system));let r=[...e.objects].sort(ir);return r.length>0&&t.at(-1)!==""&&t.push(""),r.forEach((n,o)=>{o>0&&t.push(""),t.push(...on(n))}),t.join(`
`)}function rr(e){let t=e.version==="2.0-draft"?e:{...e,version:"2.0-draft"},r=["schema 2.0-draft",""];t.system&&r.push(...nn(t.system));let n=[...t.objects].sort(ir);return n.length>0&&r.at(-1)!==""&&r.push(""),n.forEach((o,i)=>{i>0&&r.push(""),r.push(...on(o))}),r.join(`
...
`),info:o,startLine:i,endLine:d}),n=!1,o=null,i=0,a=[];return}a.push(s)}),r}function xn(e){let t=fe(e),r=te(t);return Q(r),{ast:t,document:r}}function La(e){let t=xn(e);return{...t,scene:H(t.document)}}function Va(e){return se(e)}function Fa(e){return st(e)}function Ea(e,t={}){return wt(e,t)}var Ca={background:!0,guides:!0,orbits:!0,objects:!0,labels:!0,structures:!0,metadata:!0},Ge={atlas:{name:"atlas",backgroundStart:"#041018",backgroundEnd:"#0a2331",backgroundGlow:"rgba(240, 180, 100, 0.18)",panel:"rgba(7, 17, 27, 0.9)",panelLine:"rgba(168, 207, 242, 0.18)",orbit:"rgba(163, 209, 255, 0.24)",orbitBand:"rgba(255, 190, 120, 0.28)",guide:"rgba(255, 255, 255, 0.04)",leader:"rgba(225, 238, 255, 0.4)",ink:"#e8f0ff",muted:"rgba(232, 240, 255, 0.7)",accent:"#f0b464",accentStrong:"#ff7f5f",selected:"rgba(255, 214, 139, 0.92)",starCore:"#ffcc67",starStroke:"rgba(255, 245, 203, 0.85)",starGlow:"#ffe8a3",fontFamily:'"Segoe UI Variable", "Bahnschrift", sans-serif',displayFont:'"Bahnschrift", "Segoe UI Variable", sans-serif'},nightglass:{name:"nightglass",backgroundStart:"#07131f",backgroundEnd:"#13283a",backgroundGlow:"rgba(120, 255, 215, 0.16)",panel:"rgba(7, 20, 30, 0.9)",panelLine:"rgba(120, 255, 215, 0.16)",orbit:"rgba(120, 255, 215, 0.2)",orbitBand:"rgba(137, 185, 255, 0.24)",guide:"rgba(255, 255, 255, 0.035)",leader:"rgba(192, 255, 233, 0.42)",ink:"#edfff8",muted:"rgba(237, 255, 248, 0.68)",accent:"#78ffd7",accentStrong:"#9ce7ff",selected:"rgba(120, 255, 215, 0.9)",starCore:"#e5f98c",starStroke:"rgba(246, 255, 217, 0.9)",starGlow:"#fffab4",fontFamily:'"Segoe UI Variable", "Bahnschrift", sans-serif',displayFont:'"Bahnschrift", "Segoe UI Variable", sans-serif'},ember:{name:"ember",backgroundStart:"#17090b",backgroundEnd:"#31111a",backgroundGlow:"rgba(255, 127, 95, 0.18)",panel:"rgba(24, 9, 13, 0.9)",panelLine:"rgba(255, 166, 149, 0.16)",orbit:"rgba(255, 188, 164, 0.22)",orbitBand:"rgba(255, 214, 139, 0.24)",guide:"rgba(255, 255, 255, 0.03)",leader:"rgba(255, 223, 209, 0.42)",ink:"#fff3ee",muted:"rgba(255, 243, 238, 0.68)",accent:"#ffb27d",accentStrong:"#ff7f5f",selected:"rgba(255, 178, 125, 0.9)",starCore:"#ffb766",starStroke:"rgba(255, 236, 205, 0.88)",starGlow:"#ffe2ad",fontFamily:'"Segoe UI Variable", "Bahnschrift", sans-serif',displayFont:'"Bahnschrift", "Segoe UI Variable", sans-serif'}};function $t(e){return e?typeof e=="string"?Ge[e]??Ge.atlas:{...Ge.atlas,...e}:Ge.atlas}function jt(e){return{...Ca,...e}}function In(e){return Ge[e]}function K(e){if(!e)return null;let t={query:e.query?.trim()||void 0,objectTypes:br(e.objectTypes??[]),tags:br((e.tags??[]).map(r=>r.trim()).filter(Boolean)),groupIds:br((e.groupIds??[]).map(r=>r.trim()).filter(Boolean)),includeAncestors:e.includeAncestors??!0};return Pa(t)?t:null}function Pa(e){return!!(e&&(e.query?.trim()||e.objectTypes?.length||e.tags?.length||e.groupIds?.length))}function St(e,t){let r=K(t),n=new Set;for(let o of e.objects)if(!o.hidden&&Ba(o,r)&&(n.add(o.objectId),r?.includeAncestors!==!1))for(let i of o.ancestorIds)n.add(i);return r?n:new Set(e.objects.filter(o=>!o.hidden).map(o=>o.objectId))}function kt(e,t,r=12){let n=t.trim().toLowerCase();return n?e.objects.filter(o=>!o.hidden).map(o=>({object:o,score:Ra(o,n)})).filter(o=>o.score>0).sort((o,i)=>i.score-o.score||o.object.label.localeCompare(i.object.label)).slice(0,r).map(o=>vn(o.object,o.score)):e.objects.filter(o=>!o.hidden).slice().sort((o,i)=>o.label.localeCompare(i.label)).slice(0,r).map(o=>vn(o,1))}function $n(e,t,r,n){return{version:"2.0",viewpointId:n,viewerState:{...e},renderOptions:{preset:t.preset,projection:t.projection,layers:t.layers?{...t.layers}:void 0,scaleModel:t.scaleModel?{...t.scaleModel}:void 0},filter:K(r)}}function Tt(e){return encodeURIComponent(JSON.stringify(e))}function Ot(e){let t=JSON.parse(decodeURIComponent(e));return{version:"2.0",viewpointId:t.viewpointId??null,viewerState:{scale:t.viewerState?.scale??1,rotationDeg:t.viewerState?.rotationDeg??0,translateX:t.viewerState?.translateX??0,translateY:t.viewerState?.translateY??0,selectedObjectId:t.viewerState?.selectedObjectId??null},renderOptions:{preset:t.renderOptions?.preset,projection:t.renderOptions?.projection,layers:t.renderOptions?.layers?{...t.renderOptions.layers}:void 0,scaleModel:t.renderOptions?.scaleModel?{...t.renderOptions.scaleModel}:void 0},filter:K(t.filter??null)}}function jn(e,t,r){let n=e.trim()||"bookmark";return{id:n.toLowerCase().replace(/[^a-z0-9_-]+/g,"-").replace(/^-+|-+$/g,"")||"bookmark",label:t?.trim()||n,atlasState:{...r,viewerState:{...r.viewerState},renderOptions:{...r.renderOptions,layers:r.renderOptions.layers?{...r.renderOptions.layers}:void 0,scaleModel:r.renderOptions.scaleModel?{...r.renderOptions.scaleModel}:void 0},filter:r.filter?{...r.filter}:null}}}function Mt(e){if(!(!e||!(Object.keys(e.layers).length>0)))return{background:e.layers.background,guides:e.layers.guides,orbits:e.layers["orbits-front"]===void 0&&e.layers["orbits-back"]===void 0?void 0:e.layers["orbits-front"]!==!1||e.layers["orbits-back"]!==!1,objects:e.layers.objects,labels:e.layers.labels,metadata:e.layers.metadata}}function At(e){return e?.filter?K({query:e.filter.query??void 0,objectTypes:e.filter.objectTypes,tags:e.filter.tags,groupIds:e.filter.groupIds,includeAncestors:!0}):null}function vn(e,t){return{objectId:e.objectId,label:e.label,type:e.object.type,score:t,groupId:e.groupId,parentId:e.parentId,tags:Array.isArray(e.object.properties.tags)?e.object.properties.tags.filter(r=>typeof r=="string"):[]}}function Ba(e,t){if(!t)return!0;if(t.objectTypes?.length&&!t.objectTypes.includes(e.object.type)||t.groupIds?.length&&(!e.groupId||!t.groupIds.includes(e.groupId)))return!1;if(t.tags?.length){let r=Array.isArray(e.object.properties.tags)?e.object.properties.tags.filter(n=>typeof n=="string"):[];if(!t.tags.every(n=>r.includes(n)))return!1}if(t.query?.trim()){let r=Sn(e.object,e.label).toLowerCase();if(!t.query.toLowerCase().split(/\s+/).filter(Boolean).every(o=>r.includes(o)))return!1}return!0}function Ra(e,t){let r=e.objectId.toLowerCase(),n=e.label.toLowerCase(),o=Sn(e.object,e.label).toLowerCase(),i=0;return r===t||n===t?i+=120:r.startsWith(t)||n.startsWith(t)?i+=96:(r.includes(t)||n.includes(t))&&(i+=72),t.split(/\s+/).filter(Boolean).every(c=>o.includes(c))&&(i+=32),e.object.type===t&&(i+=24),(Array.isArray(e.object.properties.tags)?e.object.properties.tags.filter(c=>typeof c=="string"):[]).some(c=>c.toLowerCase()===t)&&(i+=18),i}function Sn(e,t){let r=Object.values(e.info),n=Object.values(e.properties).flatMap(o=>Array.isArray(o)?o:typeof o=="object"&&o&&"value"in o?[String(o.value),String(o.unit??"")]:[String(o)]).filter(Boolean);return[e.id,t,e.type,...n,...r].join(" ")}function br(e){return[...new Set(e)]}var me={scale:1,rotationDeg:0,translateX:0,translateY:0,selectedObjectId:null};function gr(e){let t=e%360;return t>180&&(t-=360),t<=-180&&(t+=360),t}function Ke(e,t){return Math.min(Math.max(e,t.minScale),t.maxScale)}function Ie(e,t,r){return{...e,translateX:e.translateX+t,translateY:e.translateY+r}}function Dt(e,t){return{...e,rotationDeg:gr(e.rotationDeg+t)}}function Le(e,t,r,n,o){if(!Number.isFinite(r)||r<=0)return t;let i=$e(e),a=Ke(t.scale*r,o);if(a===t.scale)return t;let s=a/t.scale,c=n.x-i.x,d=n.y-i.y;return{...t,scale:a,translateX:(1-s)*c+s*t.translateX,translateY:(1-s)*d+s*t.translateY}}function ve(e,t,r){let n=$e(e),o=za(e.contentBounds,n,t.rotationDeg),i=Math.max(e.width-r.fitPadding*2,1),a=Math.max(e.height-r.fitPadding*2,1),s=Math.max(o.width,1),c=Math.max(o.height,1),d=Ke(Math.min(i/s,a/c),r),u=ae({x:e.contentBounds.centerX,y:e.contentBounds.centerY},n,t.rotationDeg);return{...t,scale:d,translateX:n.x-(n.x+(u.x-n.x)*d),translateY:n.y-(n.y+(u.y-n.y)*d)}}function Lt(e,t,r,n){let o=e.objects.find(c=>c.objectId===r&&!c.hidden);if(!o)return t;let i=$e(e),a=Ke(Math.max(t.scale,1.8),n),s=ae({x:o.x,y:o.y},i,t.rotationDeg);return{...t,scale:a,translateX:i.x-(i.x+(s.x-i.x)*a),translateY:i.y-(i.y+(s.y-i.y)*a),selectedObjectId:r}}function Vt(e,t){let r=$e(e);return`translate(${t.translateX} ${t.translateY}) translate(${r.x} ${r.y}) rotate(${t.rotationDeg}) scale(${t.scale}) translate(${-r.x} ${-r.y})`}function Ve(e,t,r){let n=$e(e),o={x:r.x-t.translateX,y:r.y-t.translateY},i={x:o.x-n.x,y:o.y-n.y},a={x:i.x/Math.max(t.scale,1e-4),y:i.y/Math.max(t.scale,1e-4)},s=ae({x:a.x,y:a.y},{x:0,y:0},-t.rotationDeg);return{x:n.x+s.x,y:n.y+s.y}}function Ft(e,t){let r=[{x:0,y:0},{x:e.width,y:0},{x:e.width,y:e.height},{x:0,y:e.height}].map(s=>Ve(e,t,s)),n=Math.min(...r.map(s=>s.x)),o=Math.min(...r.map(s=>s.y)),i=Math.max(...r.map(s=>s.x)),a=Math.max(...r.map(s=>s.y));return{minX:n,minY:o,maxX:i,maxY:a,width:i-n,height:a-o,centerX:n+(i-n)/2,centerY:o+(a-o)/2}}function $e(e){return{x:e.width/2,y:e.height/2}}function za(e,t,r){let n=[{x:e.minX,y:e.minY},{x:e.maxX,y:e.minY},{x:e.maxX,y:e.maxY},{x:e.minX,y:e.maxY}].map(c=>ae(c,t,r)),o=Math.min(...n.map(c=>c.x)),i=Math.min(...n.map(c=>c.y)),a=Math.max(...n.map(c=>c.x)),s=Math.max(...n.map(c=>c.y));return{minX:o,minY:i,maxX:a,maxY:s,width:a-o,height:s-i,centerX:o+(a-o)/2,centerY:i+(s-i)/2}}var Ct="worldorbit-camera-root";function re(e,t={}){let r=$t(t.theme),n=rs(t.preset??e.renderPreset??void 0),o=jt({...n.layers,...t.layers}),i=t.subtitle??e.subtitle,a=St(e,t.filter??null),s=e.objects.filter(y=>!y.hidden).filter(y=>a.has(y.objectId)).filter(y=>o.structures||!Et(y.object)).sort((y,v)=>y.sortKey-v.sortKey),c=e.labels.filter(y=>!y.hidden).filter(y=>a.has(y.objectId)).filter(y=>o.structures||!Et(y.object)),d=Wa(s),u=o.orbits?_a(e,a,o.structures):{back:"",front:""},f=o.guides?e.leaders.filter(y=>!y.hidden).filter(y=>a.has(y.objectId)).filter(y=>o.structures||!Et(y.object)).map(y=>`<line class="wo-leader wo-leader-${y.mode}" x1="${y.x1}" y1="${y.y1}" x2="${y.x2}" y2="${y.y2}" data-render-id="${q(y.renderId)}" data-group-id="${le(y.groupId??"")}" />`).join(""):"",w=o.objects?s.map(y=>Ya(y,t.selectedObjectId??null,r)).join(""):"",g=o.labels?c.map(y=>Ua(e,y,t.selectedObjectId??null)).join(""):"",I=o.metadata?`<text class="wo-title" x="56" y="64">${q(e.title)}</text>
  ...
  <text class="wo-meta" x="56" y="${e.height-42}">${q(os(e))}</text>`:"",x=o.background?`<rect class="wo-bg" x="0" y="0" width="${e.width}" height="${e.height}" rx="28" ry="28" />
  <rect class="wo-bg-glow" x="0" y="0" width="${e.width}" height="${e.height}" rx="28" ry="28" />
  ${o.guides?ns(e.width,e.height):""}`:"";return`<svg xmlns="http://www.w3.org/2000/svg" data-worldorbit-svg="true" width="${e.width}" height="${e.height}" viewBox="0 0 ${e.width} ${e.height}" preserveAspectRatio="xMidYMid meet" role="img" aria-labelledby="worldorbit-title worldorbit-desc">
  ...
  <g data-worldorbit-world="true">
    <g data-worldorbit-camera-root="${Ct}" id="${Ct}">
...
</svg>`}function xr(e,t={}){return re(H(e,t),t)}function Mn(e,t={}){let r=se(e);return xr(r.document,Na(r,t))}function Na(e,t){let r=e.atlasDocument??e.draftDocument;return t.preset||!r?.system?.defaults.preset?t:{...t,preset:r.system.defaults.preset}}function _a(e,t,r){let n=[],o=[];for(let i of e.orbitVisuals.filter(a=>!a.hidden&&t.has(a.objectId)&&(r||!Et(a.object)))){let a=i.bandThickness??(i.band?10:1.5),s=i.band?"wo-orbit wo-orbit-band wo-orbit-node":"wo-orbit wo-orbit-node",c=`data-render-id="${q(i.renderId)}" data-orbit-object-id="${le(i.objectId)}" data-parent-id="${le(i.parentId)}" data-group-id="${le(i.groupId??"")}"`;if(i.backArcPath||i.frontArcPath){i.backArcPath&&n.push(`<path class="${s} wo-orbit-back" d="${i.backArcPath}" stroke-width="${a}" ${c} />`),i.frontArcPath&&o.push(`<path class="${s} wo-orbit-front" d="${i.frontArcPath}" stroke-width="${a}" ${c} />`);continue}if(i.kind==="ellipse"){let d=i.rx??i.radius??0,u=i.ry??i.radius??0;o.push(`<ellipse class="${s} wo-orbit-front" cx="${i.cx}" cy="${i.cy}" rx="${d}" ry="${u}" transform="rotate(${i.rotationDeg} ${i.cx} ${i.cy})" stroke-width="${a}" ${c} />`);continue}o.push(`<circle class="${s} wo-orbit-front" cx="${i.cx}" cy="${i.cy}" r="${i.radius??0}" stroke-width="${a}" ${c} />`)}return{back:n.join(""),front:o.join("")}}function Wa(e){return e.filter(t=>!!t.imageHref).map(t=>Ha(t)).join("")}function Ya(e,t,r){let{object:n,x:o,y:i,radius:a,visualRadius:s}=e,c=t===e.objectId?" wo-object-selected":"",d=n.properties.kind?` wo-kind-${String(n.properties.kind).toLowerCase().replace(/[^a-z0-9-]/g,"-")}`:"",u=Ka(e,r),f=Xa(e),w=f?kn(n,o,i,a,u,{outlineOnly:!0}):"";return`<g class="wo-object wo-object-${n.type}${d}${c}" data-object-id="${q(e.objectId)}" data-parent-id="${le(e.parentId??"")}" data-group-id="${le(e.groupId??"")}" data-render-id="${q(e.renderId)}" tabindex="0" role="button" aria-label="${q(`${n.type} ${e.objectId}`)}">
    <circle class="wo-selection-ring" cx="${o}" cy="${i}" r="${s+8}" />
    ${qa(e,u)}
    ${kn(n,o,i,a,u)}
    ${f}
    ${w}
  </g>`}function Ua(e,t,r){let n=r===t.objectId?" wo-object-label-selected":"",o=e.scaleModel.labelMultiplier;return`<g class="wo-object-label${n}" data-object-id="${q(t.objectId)}" data-group-id="${le(t.groupId??"")}" data-render-id="${q(t.renderId)}">
  ...
  </g>`}function kn(e,t,r,n,o,i={}){let a=i.outlineOnly?"transparent":o.fill,s=o.tail??o.fill;switch(e.type){case"star":return i.outlineOnly?`<circle cx="${t}" cy="${r}" r="${n}" fill="transparent" stroke="${o.stroke}" stroke-width="2" />`:`<circle cx="${t}" cy="${r}" r="${n*2.4}" fill="${o.glow??"url(#wo-star-glow)"}" opacity="0.84" />
...
<circle cx="${t}" cy="${r}" r="${n}" fill="${a}" stroke="${o.stroke}" stroke-width="1.4" />`;case"structure":return`<polygon points="${Dn(t,r,n)}" fill="${a}" stroke="${o.stroke}" stroke-width="1.4" />`;case"phenomenon":{let c=String(e.properties.kind??"").toLowerCase().replace(/_/g,"-");return i.outlineOnly?c==="black-hole"||c==="nebula"||c==="galaxy"||c==="dwarf-galaxy"?`<circle cx="${t}" cy="${r}" r="${n}" fill="transparent" stroke="${o.stroke}" stroke-width="1.4" />`:`<polygon points="${yr(t,r,n)}" fill="transparent" stroke="${o.stroke}" stroke-width="1.4" />`:c==="black-hole"?`<ellipse cx="${t}" cy="${r}" rx="${n*2.4}" ry="${n*.55}" fill="none" stroke="${o.accentRing??o.stroke}" stroke-width="3.5" />
<circle cx="${t}" cy="${r}" r="${n}" fill="${a}" stroke="${o.stroke}" stroke-width="2" />`:c==="galaxy"?`<ellipse cx="${t}" cy="${r}" rx="${n*2.6}" ry="${n}" fill="${o.halo??"none"}" stroke="none" />
<ellipse cx="${t}" cy="${r}" rx="${n*1.5}" ry="${n*.42}" fill="${a}" stroke="${o.stroke}" stroke-width="1.2" />
<circle cx="${t}" cy="${r}" r="${n*.28}" fill="${o.core??"#fff"}" stroke="none" />`:c==="dwarf-galaxy"?`<ellipse cx="${t}" cy="${r}" rx="${n*1.6}" ry="${n*.55}" fill="${a}" stroke="${o.stroke}" stroke-width="1" />
<circle cx="${t}" cy="${r}" r="${n*.25}" fill="${o.core??"#fff"}" stroke="none" />`:c==="nebula"?`<circle cx="${t}" cy="${r}" r="${n*2.2}" fill="${o.halo??"none"}" stroke="none" />
<circle cx="${t}" cy="${r}" r="${n}" fill="${a}" stroke="${o.stroke}" stroke-width="1" />`:`<polygon points="${yr(t,r,n)}" fill="${a}" stroke="${o.stroke}" stroke-width="1.4" />`}}}function qa(e,t){if(!t.atmosphere)return"";let{object:r,x:n,y:o,radius:i}=e;return r.type!=="planet"&&r.type!=="moon"&&r.type!=="asteroid"?"":`<circle cx="${n}" cy="${o}" r="${i+4}" fill="none" stroke="${t.atmosphere}" stroke-width="4" opacity="0.45" />`}function Xa(e){if(!e.imageHref)return"";let t=Ga(e);return`<image class="wo-object-image" x="${t.x}" y="${t.y}" width="${t.width}" height="${t.height}" href="${le(e.imageHref)}" preserveAspectRatio="xMidYMid slice" clip-path="url(#${le(An(e))})" />`}function Ha(e){let{x:t,y:r,radius:n}=e,o="";switch(e.object.type){case"star":case"planet":case"moon":case"asteroid":case"comet":o=`<circle cx="${t}" cy="${r}" r="${n}" />`;break;case"structure":o=`<polygon points="${Dn(t,r,n)}" />`;break;case"phenomenon":o=`<polygon points="${yr(t,r,n)}" />`;break;default:return""}return`<clipPath id="${le(An(e))}" clipPathUnits="userSpaceOnUse">${o}</clipPath>`}function Ga(e){let{object:t,x:r,y:n,radius:o}=e;switch(t.type){case"structure":return{x:r-o,y:n-o,width:o*2,height:o*2};case"phenomenon":return{x:r-o*1.2,y:n-o*1.2,width:o*2.4,height:o*2.4};default:return{x:r-o,y:n-o,width:o*2,height:o*2}}}function Ka(e,t){let r=String(e.object.properties.kind??"").toLowerCase().replace(/_/g,"-"),n=Ja(e.object.type,r,t),o=e.fillColor&&as(e.fillColor)?e.fillColor:n.fill,i=Tn(e.object.properties.albedo),a=Tn(e.object.properties.temperature),s=Qa(o,a,i,e.object.type),c=Je(s,"#ffffff",.4)??n.stroke,d=ts(e.object.properties.atmosphere),u=e.object.type==="star"?On(Je(s,"#fff2cb",.4)??s,.82):void 0;return{fill:s,stroke:c,glow:u,atmosphere:d,tail:e.object.type==="comet"?On(Je(s,"#ffffff",.5)??s,.72):void 0}}function Ja(e,t,r){switch(e){case"star":return{fill:r.starCore,stroke:r.starStroke};case"planet":return{fill:"#72b7ff",stroke:"#d8efff"};case"moon":return{fill:"#c7d7ea",stroke:"#f2f8ff"};case"belt":return{fill:"#d9aa74",stroke:"#f7d5aa"};case"asteroid":return{fill:"#a7a5b8",stroke:"#ebe5ff"};case"comet":return{fill:"#9ce7ff",stroke:"#e7fbff"};case"ring":return{fill:"#e59f7d",stroke:"#fff0d3"};case"structure":return{fill:r.accentStrong,stroke:"#fff2ea"};case"phenomenon":return Za(t)}}function Za(e){return e==="galaxy"?{fill:"rgba(165,125,255,0.55)",stroke:"rgba(210,185,255,0.75)",halo:"rgba(160,120,255,0.10)",core:"#ede0ff"}:e==="dwarf-galaxy"?{fill:"rgba(190,165,255,0.45)",stroke:"rgba(220,205,255,0.75)",core:"#ddd0ff"}:e==="black-hole"?{fill:"#040408",stroke:"#ff6a00",accentRing:"rgba(255,140,20,0.72)"}:e==="nebula"?{fill:"rgba(105,205,255,0.45)",stroke:"rgba(180,235,255,0.72)",halo:"rgba(100,200,255,0.08)"}:e==="void"?{fill:"#05080f",stroke:"rgba(130,160,255,0.4)"}:{fill:"#78ffd7",stroke:"#e9fff7"}}function Qa(e,t,r,n){let o=e;if(t!==null){let i=es(t,n);o=Je(o,i,n==="star"?.42:.2)??o}if(r!==null){let i=Math.min(Math.max(r,0),1);o=Je(o,i>=.5?"#ffffff":"#0f1520",Math.abs(i-.5)*.7)??o}return o}function es(e,t){return t==="star"?e>=8e3?"#d7ebff":e>=6e3?"#fff3d8":e>=4e3?"#ffd39a":"#ff9d76":e<=180?"#8fd8ff":e>=600?"#ffb56e":"#fff1c4"}function ts(e){if(typeof e!="string"||!e.trim())return;let t=e.trim().toLowerCase();return t.includes("methane")?"rgba(134, 236, 255, 0.75)":t.includes("nitrogen")||t.includes("oxygen")||t.includes("air")?"rgba(122, 194, 255, 0.75)":t.includes("carbon")||t.includes("co2")?"rgba(255, 198, 138, 0.75)":t.includes("sulfur")?"rgba(255, 233, 138, 0.75)":"rgba(180, 222, 255, 0.68)"}function rs(e){switch(e){case"presentation":return{layers:{background:!0,guides:!0,orbits:!0,objects:!0,labels:!0,structures:!0,metadata:!0}};case"atlas-card":return{layers:{background:!0,guides:!1,orbits:!0,objects:!0,labels:!0,structures:!0,metadata:!0}};case"markdown":return{layers:{background:!0,guides:!1,orbits:!0,objects:!0,labels:!0,structures:!0,metadata:!1}};default:return{layers:{background:!0,guides:!0,orbits:!0,objects:!0,labels:!0,structures:!0,metadata:!0}}}}function Tn(e){return typeof e=="number"?e:e&&typeof e=="object"&&"value"in e?e.value:null}function An(e){return`${e.renderId}-clip`}function Dn(e,t,r){return`${e},${t-r} ${e+r},${t} ${e},${t+r} ${e-r},${t}`}function yr(e,t,r){return`${e},${t-r*1.2} ${e+r*.9},${t-r*.3} ${e+r*1.2},${t+r*.8} ${e},${t+r*1.2} ${e-r*1.1},${t+r*.3} ${e-r*.8},${t-r*.8}`}function ns(e,t){let r=Array.from({length:10},(o,i)=>{let a=90+i*((e-180)/9);return`<line class="wo-grid" x1="${a}" y1="120" x2="${a}" y2="${t-70}" />`}).join(""),n=Array.from({length:6},(o,i)=>{let a=150+i*((t-240)/5);return`<line class="wo-grid" x1="56" y1="${a}" x2="${e-56}" y2="${a}" />`}).join("");return`${r}${n}`}function os(e){return[`${e.layoutPreset} layout`,`${e.viewMode} view`,`${e.renderPreset??"custom"} preset`,`schema ${e.metadata.version??"1.0"}`].join(" - ")}function Et(e){return e.type==="structure"||e.type==="phenomenon"}function Je(e,t,r){let n=wr(e),o=wr(t);if(!n||!o)return;let i=Math.min(Math.max(r,0),1);return is({r:Math.round(n.r+(o.r-n.r)*i),g:Math.round(n.g+(o.g-n.g)*i),b:Math.round(n.b+(o.b-n.b)*i)})}function On(e,t){let r=wr(e);return r?`rgba(${r.r}, ${r.g}, ${r.b}, ${t})`:e}function wr(e){let t=e.trim();return/^#[0-9a-f]{6}$/i.test(t)?{r:Number.parseInt(t.slice(1,3),16),g:Number.parseInt(t.slice(3,5),16),b:Number.parseInt(t.slice(5,7),16)}:/^#[0-9a-f]{3}$/i.test(t)?{r:Number.parseInt(t[1]+t[1],16),g:Number.parseInt(t[2]+t[2],16),b:Number.parseInt(t[3]+t[3],16)}:null}function is(e){let t=r=>r.toString(16).padStart(2,"0");return`#${t(e.r)}${t(e.g)}${t(e.b)}`}function as(e){return!!e.trim()}function q(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;")}function le(e){return q(e)}var Fe=180,Ee=120,Ln=10;function Vn(e,t,r){let n=e.contentBounds.width>0&&e.contentBounds.height>0?e.contentBounds:{minX:0,minY:0,maxX:e.width,maxY:e.height,width:e.width,height:e.height,centerX:e.width/2,centerY:e.height/2},o=Math.min((Fe-Ln*2)/Math.max(n.width,1),(Ee-Ln*2)/Math.max(n.height,1)),i=(Fe-n.width*o)/2-n.minX*o,a=(Ee-n.height*o)/2-n.minY*o,s=Ft(e,t),c=r.map(d=>{let u=d.x*o+i,f=d.y*o+a,w=Math.max(1.4,Math.min(d.visualRadius*o,5.2)),g=d.fillColor??ss(d.object.type);return`<circle cx="${ne(u)}" cy="${ne(f)}" r="${ne(w)}" fill="${g}" fill-opacity="0.92" />`}).join("");return`<div data-worldorbit-minimap="true" style="position:absolute;right:16px;bottom:16px;width:${Fe}px;height:${Ee}px;padding:8px;border-radius:16px;background:rgba(5, 14, 22, 0.78);border:1px solid rgba(179, 216, 255, 0.16);box-shadow:0 14px 28px rgba(0, 0, 0, 0.24);backdrop-filter:blur(8px);pointer-events:none;">
  <svg width="${Fe}" height="${Ee}" viewBox="0 0 ${Fe} ${Ee}" role="presentation" aria-hidden="true">
    <rect x="0.5" y="0.5" width="${Fe-1}" height="${Ee-1}" rx="12" ry="12" fill="rgba(7, 17, 27, 0.85)" stroke="rgba(179, 216, 255, 0.18)" />
...
</div>`}function ss(e){switch(e){case"star":return"#ffcc67";case"planet":return"#72b7ff";case"moon":return"#c7d7ea";case"belt":case"ring":return"#d9aa74";case"asteroid":return"#a7a5b8";case"comet":return"#9ce7ff";case"structure":return"#ff7f5f";case"phenomenon":return"#78ffd7"}}function ne(e){return Number.isInteger(e)?String(e):e.toFixed(2)}var ls=["radius","temperature","atmosphere","period","semiMajor","distance","eccentricity","angle","inclination","phase","albedo","mass","density","gravity"];function En(e){return{objectId:e.objectId,title:e.objectId,typeLabel:ps(e.object.type),imageHref:e.renderObject.imageHref??null,description:ds(e),tags:us(e.object.properties.tags),fields:cs(e),parentLabel:e.parent?.objectId??null,orbitLabel:e.orbit?.parentId??null,details:e}}function Cn(e,t){let r=e.tags.length?`<div class="wo-tooltip-tags">${e.tags.map(i=>`<span class="wo-tooltip-tag">${ce(i)}</span>`).join("")}</div>`:"",n=e.fields.length?`<dl class="wo-tooltip-fields">${e.fields.map(i=>`<div class="wo-tooltip-field"><dt>${ce(i.label)}</dt><dd>${ce(i.value)}</dd></div>`).join("")}</dl>`:"",o=[e.parentLabel?`Parent: ${e.parentLabel}`:null,e.orbitLabel?`Orbit: ${e.orbitLabel}`:null,t==="pinned"?"Pinned tooltip":"Hover tooltip"].filter(Boolean);return`<article class="wo-tooltip-card" data-tooltip-object-id="${ce(e.objectId)}">
    <div class="wo-tooltip-head">
      ${e.imageHref?`<img class="wo-tooltip-image" src="${hs(e.imageHref)}" alt="" />`:`<div class="wo-tooltip-image wo-tooltip-image-placeholder">${ce(e.typeLabel.slice(0,1))}</div>`}
      <div class="wo-tooltip-heading">
        <strong>${ce(e.title)}</strong>
        <span>${ce(e.typeLabel)}</span>
      </div>
    </div>
    ${e.description?`<p class="wo-tooltip-description">${ce(e.description)}</p>`:""}
    ${r}
    ${n}
    ${o.length?`<p class="wo-tooltip-relations">${ce(o.join(" - "))}</p>`:""}
  ...
  `,document.head.append(e)}var Is="[data-worldorbit-embed]";function Ir(e){return encodeURIComponent(JSON.stringify(e))}function vr(e){let t=JSON.parse(decodeURIComponent(e));return{version:"2.0",mode:t.mode??"interactive",scene:t.scene,options:t.options?{...t.options,initialFilter:t.options.initialFilter??null,atlasState:t.options.atlasState??null}:void 0}}function Wn(e,t,r={}){return{version:"2.0",mode:t,scene:e,options:{initialViewpointId:r.initialViewpointId,initialSelectionObjectId:r.initialSelectionObjectId,initialFilter:r.initialFilter??null,atlasState:r.atlasState??null,minimap:r.minimap}}}function Yn(e,t={}){let r={...e,options:{...e.options,theme:t.theme??e.options?.theme,layers:t.layers??e.options?.layers,subtitle:t.subtitle??e.options?.subtitle,preset:t.preset??e.options?.preset,initialViewpointId:t.initialViewpointId??e.options?.initialViewpointId,initialSelectionObjectId:t.initialSelectionObjectId??e.options?.initialSelectionObjectId,initialFilter:t.initialFilter??e.options?.initialFilter??null,atlasState:t.atlasState??e.options?.atlasState??null,minimap:t.minimap??e.options?.minimap}},n=re(e.scene,{theme:r.options?.theme,layers:r.options?.layers,filter:r.options?.initialFilter??null,selectedObjectId:r.options?.initialSelectionObjectId??null,subtitle:r.options?.subtitle,preset:r.options?.preset});return`<div class="${Bt(t.className??"worldorbit-embed")}" data-worldorbit-embed="true" data-worldorbit-mode="${e.mode}" data-worldorbit-preset="${Bt(r.options?.preset??e.scene.renderPreset??"custom")}" data-worldorbit-viewpoint="${Bt(r.options?.initialViewpointId??"")}" data-worldorbit-payload="${Bt(Ir(r))}">${n}</div>`}function Un(e=document,t={}){let r=new Map,n=[...e.querySelectorAll(Is)];for(let o of n){let i=vs(o),a=t.mode??i.mode,s=t.theme??i.options?.theme,c=t.layers??i.options?.layers,d=t.subtitle??i.options?.subtitle,u=t.preset??i.options?.preset??i.scene.renderPreset??void 0,f=t.viewer?.initialFilter??i.options?.initialFilter??null,w=t.viewer?.initialViewpointId??i.options?.initialViewpointId,g=t.viewer?.initialSelectionObjectId??i.options?.initialSelectionObjectId,I=t.viewer?.minimap??i.options?.minimap;if(a==="interactive"){let x=he(o,{...t.viewer,scene:i.scene,width:t.width??i.scene.width,height:t.height??i.scene.height,padding:t.padding??i.scene.padding,preset:u,theme:s,layers:c,subtitle:d,initialFilter:f,initialViewpointId:w,initialSelectionObjectId:g,minimap:I});i.options?.atlasState&&x.setAtlasState(i.options.atlasState),r.set(o,x),t.onMount?.(x,o)}else o.innerHTML=re(i.scene,{width:t.width??i.scene.width,height:t.height??i.scene.height,padding:t.padding??i.scene.padding,preset:u,theme:s,layers:c,filter:f,selectedObjectId:g??null,subtitle:d}),t.onMount?.(null,o);o.dataset.worldorbitMounted="true"}return{viewers:[...r.values()],destroy(){for(let[o,i]of r.entries())i.destroy(),o.removeAttribute("data-worldorbit-mounted");r.clear()}}}function vs(e){let t=e.dataset.worldorbitPayload;if(!t)throw new Error("WorldOrbit embed is missing data-worldorbit-payload.");return vr(t)}function Bt(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}var qn="worldorbit-atlas-viewer-style";function Rt(e,t){if(typeof document>"u")throw new Error("Atlas viewer requires a browser environment.");js();let r={search:t.controls?.search??!0,typeFilter:t.controls?.typeFilter??!0,viewpointSelect:t.controls?.viewpointSelect??!0,inspector:t.controls?.inspector??!0,bookmarks:t.controls?.bookmarks??!0};e.classList.add("wo-atlas-viewer"),e.innerHTML=$s(r);let n=e.querySelector("[data-atlas-toolbar]"),o=e.querySelector("[data-atlas-search]"),i=e.querySelector("[data-atlas-type-filter]"),a=e.querySelector("[data-atlas-viewpoint]"),s=e.querySelector("[data-atlas-bookmark]"),c=e.querySelector("[data-atlas-bookmarks]"),d=e.querySelector("[data-atlas-results]"),u=e.querySelector("[data-atlas-inspector]"),f=e.querySelector("[data-atlas-stage]");if(!f)throw new Error("Atlas viewer failed to initialize its stage container.");let w=K(t.initialFilter??null),g=t.initialQuery?.trim()??w?.query??"",I=t.initialObjectType??(w?.objectTypes?.length===1?w.objectTypes[0]:null),x=[],y;y=he(f,{...t,initialFilter:null,onSelectionChange(h){y&&O(),t.onSelectionChange?.(h)},onSelectionDetailsChange(h){y&&O(),t.onSelectionDetailsChange?.(h)},onFilterChange(h,j){y&&(L(h),W(),O()),t.onFilterChange?.(h,j)},onViewpointChange(h){y&&(V(),O()),t.onViewpointChange?.(h)},onAtlasStateChange(h){y&&O(),t.onAtlasStateChange?.(h)},onViewChange(h){y&&O(),t.onViewChange?.(h)}}),F(),E(),L(y.getFilter()),J(),W(),O(),o?.addEventListener("input",()=>{g=o.value.trim(),F()}),i?.addEventListener("change",()=>{I=i.value||null,F()}),a?.addEventListener("change",()=>{let h=v();if(!a.value){h.resetView(),F();return}h.goToViewpoint(a.value),O()}),s?.addEventListener("click",()=>{let h=v(),j=h.getActiveViewpoint()?.label??h.getSelectionDetails()?.objectId??`Bookmark ${x.length+1}`;x=[...x,h.captureBookmark(j,j)],J(),O()}),c?.addEventListener("click",h=>{let j=h.target?.closest("[data-bookmark-id]");if(!j)return;let N=x.find(Se=>Se.id===j.dataset.bookmarkId);if(!N)return;let be=v();be.applyBookmark(N),L(be.getFilter()),W(),O()}),d?.addEventListener("click",h=>{let j=h.target?.closest("[data-object-id]");j&&(v().focusObject(j.dataset.objectId??""),O())});function v(){if(!y)throw new Error("Atlas viewer is not initialized.");return y}return{element:e,get viewer(){return v()},getViewer(){return v()},setSource(h){v().setSource(h),A()},setDocument(h){v().setDocument(h),A()},setScene(h){v().setScene(h),A()},getAtlasState(){return v().getAtlasState()},setAtlasState(h){let j=v();j.setAtlasState(h),L(j.getFilter()),W(),O()},getInspectorSnapshot(){return z()},getSearchQuery(){return g},setSearchQuery(h){g=h.trim(),o&&(o.value=g),F()},getObjectTypeFilter(){return I},setObjectTypeFilter(h){I=h,i&&(i.value=h??""),F()},listSearchResults(h=6){return v().search(g,h)},listBookmarks(){return x.map(Xn)},captureBookmark(h,j){let N=v().captureBookmark(h,j);return x=[...x,N],J(),O(),Xn(N)},applyBookmark(h){let j=v(),N=j.applyBookmark(h);return N&&(L(j.getFilter()),W(),O()),N},goToViewpoint(h){let j=v().goToViewpoint(h);return j&&O(),j},exportSvg(){return v().exportSvg()},destroy(){v().destroy(),e.innerHTML="",e.classList.remove("wo-atlas-viewer")}};function A(){E(),F(),J(),W(),O()}function F(){v().setFilter(B()),E(),W(),O()}function B(){return K({query:g||void 0,objectTypes:I?[I]:void 0,tags:w?.tags,groupIds:w?.groupIds,includeAncestors:w?.includeAncestors??!0})}function L(h){g=h?.query?.trim()??"",I=h?.objectTypes?.length===1?h.objectTypes[0]:null,o&&document.activeElement!==o&&(o.value=g),i&&(i.value=I??"")}function E(){if(!a)return;let h=v(),j=h.getActiveViewpoint()?.id??"";a.innerHTML=['<option value="">Scene default</option>',...h.listViewpoints().map(N=>`<option value="${je(N.id)}">${je(N.label)}</option>`)].join(""),a.value=j}function V(){a&&(a.value=v().getActiveViewpoint()?.id??"")}function W(){if(!d)return;let h=v().search(g,6);d.innerHTML=h.map(j=>`<button type="button" class="wo-atlas-pill" data-object-id="${je(j.objectId)}">${je(j.objectId)} - ${je(j.type)}</button>`).join("")}function O(){let h=z();u&&(u.textContent=JSON.stringify(h,null,2)),t.onInspectorChange?.(h)}function z(){let h=v();return{selection:h.getSelectionDetails(),activeViewpoint:h.getActiveViewpoint(),filter:h.getFilter(),atlasState:h.getAtlasState(),visibleObjectIds:h.getVisibleObjects().map(j=>j.objectId),scene:{title:h.getScene().title,projection:h.getScene().projection,renderPreset:h.getScene().renderPreset,groupCount:h.getScene().groups.length,viewpointCount:h.getScene().viewpoints.length}}}function J(){c&&(c.innerHTML=x.map(h=>`<button type="button" class="wo-atlas-pill" data-bookmark-id="${je(h.id)}">${je(h.label)}</button>`).join(""))}}function $s(e){let t=[e.search?`<label class="wo-atlas-field">
          <span>Search</span>
  ...
  </section>`}function js(){if(document.getElementById(qn))return;let e=document.createElement("style");e.id=qn,e.textContent=`
  ...
  `,document.head.append(e)}function Xn(e){return{...e,atlasState:{...e.atlasState,viewerState:{...e.atlasState.viewerState},renderOptions:{...e.atlasState.renderOptions,layers:e.atlasState.renderOptions.layers?{...e.atlasState.renderOptions.layers}:void 0,scaleModel:e.atlasState.renderOptions.scaleModel?{...e.atlasState.renderOptions.scaleModel}:void 0},filter:e.atlasState.filter?{...e.atlasState.filter}:null}}}function je(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}function Hn(e="worldorbit-viewer"){if(typeof window>"u"||typeof customElements>"u"||customElements.get(e))return;class t extends HTMLElement{static get observedAttributes(){return["source","mode","theme"]}viewer=null;connectedCallback(){this.renderCurrent()}disconnectedCallback(){this.viewer?.destroy(),this.viewer=null}attributeChangedCallback(){this.isConnected&&this.renderCurrent()}renderCurrent(){this.viewer?.destroy(),this.viewer=null;let n=this.getAttribute("source")??this.textContent??"",o=this.getAttribute("mode")??"interactive";if(!n.trim()){this.innerHTML="";return}let i=Ss(n),a=H(i),s=this.getAttribute("theme")??void 0;if(o==="static"){this.innerHTML=re(a,{theme:s});return}if(o==="atlas"){this.viewer=Rt(this,{scene:a,theme:s});return}this.viewer=he(this,{scene:a,theme:s})}}customElements.define(e,t)}function Ss(e){return se(e).document}return uo(ks);})();
