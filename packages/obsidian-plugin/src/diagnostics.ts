...
export function formatDiagnosticLocation(diagnostic: WorldOrbitDiagnostic): string {
  if (!diagnostic.line) {
    return "No position";
  }
...
export function summarizeDiagnostics(diagnostics: WorldOrbitDiagnostic[]): string {
